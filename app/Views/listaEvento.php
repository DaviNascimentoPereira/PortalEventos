                ...
                <table class="table table-hover" id="atividades">
                    ...
                    <tbody>
                        <?php foreach ($data as $key => $atividade) {
                            ...
                            echo '<tr><td>' . $atividade['id'] . '</td><td>' . $atividade['titulo'] . '</td><td class="datainicial">' . date_format(new DateTime($atividade['dtInicio']), "d/m/Y H:i") . '</td><td>' . date_format(new DateTime($atividade['dtFim']), "d/m/Y  - H:i") . '</td>';
                            echo '<td>';
                            $inscrito = false;
